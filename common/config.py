...
def parse_opts():
    r"""arguments"""
    parser = argparse.ArgumentParser(description='Global-Local Query-Support-Cross-Attention For Few-Shot Semantic Segmentaion')
    # common
    parser.add_argument('--datapath', type=str, default='/root/SCF/Data/Few_Shot_data')
