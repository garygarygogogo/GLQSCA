...
class SwinTransformer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        W = int(N**0.5)
        # print(feats.size())
        feature = x.reshape(B, H, W, -1).permute(0, 3, 1, 2).contiguous()
        # print(x.size())
...
if __name__ == '__main__':
    ...
    net.load_state_dict(torch.load("/home/henry/Code/few_shot_segmentation/DCAMA-main/pretrained_models/swin_base_patch4_window12_384.pth")['model'])
