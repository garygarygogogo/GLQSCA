...
from model.Network_v7 import GLQSCA
...
if __name__ == '__main__':
    ...
    model = GLQSCA(args.backbone, args.feature_extractor_path, False)
    ...
    FSSDataset.initialize(img_size=352, datapath=args.datapath, use_original_imgsize=False)
